...
class TestTransfer:
    ...
    def test_method_get_total(self, client: EmceesProdTesting5) -> None:
        ...
        assert_matches_type(TransferGetTotalResponse, transfer, path=["response"])
    ...
    def test_method_list_by_asset_account(self, client: EmceesProdTesting5) -> None:
        ...
        assert_matches_type(TransferListByAssetAccountResponse, transfer, path=["response"])
    ...
    def test_method_list_by_category(self, client: EmceesProdTesting5) -> None:
        ...
        assert_matches_type(TransferListByCategoryResponse, transfer, path=["response"])
    ...
    def test_method_list_by_tag(self, client: EmceesProdTesting5) -> None:
        ...
        assert_matches_type(TransferListByTagResponse, transfer, path=["response"])
    ...
    def test_method_list_without_category(self, client: EmceesProdTesting5) -> None:
        ...
        assert_matches_type(TransferListWithoutCategoryResponse, transfer, path=["response"])
    ...
    def test_method_list_without_tag(self, client: EmceesProdTesting5) -> None:
        ...
        assert_matches_type(TransferListWithoutTagResponse, transfer, path=["response"])
