...
from ._exceptions import APIStatusError, MoreConflictingError
...
class MoreConflicting(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous MoreConflicting client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("MORE_CONFLICTING_BASE_URL")
        if base_url is None:
            base_url = f"https://petstore3.swagger.io/api/v3"

        custom_headers_env = os.environ.get("MORE_CONFLICTING_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> MoreConflictingWithRawResponse:
        return MoreConflictingWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> MoreConflictingWithStreamedResponse:
        return MoreConflictingWithStreamedResponse(self)
...
class AsyncMoreConflicting(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncMoreConflicting client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncMoreConflictingWithRawResponse:
        return AsyncMoreConflictingWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncMoreConflictingWithStreamedResponse:
        return AsyncMoreConflictingWithStreamedResponse(self)
...
class MoreConflictingWithRawResponse:
    _client: MoreConflicting

    def __init__(self, client: MoreConflicting) -> None:
        self._client = client
...
class AsyncMoreConflictingWithRawResponse:
    _client: AsyncMoreConflicting

    def __init__(self, client: AsyncMoreConflicting) -> None:
        self._client = client
...
class MoreConflictingWithStreamedResponse:
    _client: MoreConflicting
...
class AsyncMoreConflictingWithStreamedResponse:
    _client: AsyncMoreConflicting
...
AsyncClient = AsyncMoreConflicting
