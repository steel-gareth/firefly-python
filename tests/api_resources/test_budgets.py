...
class TestBudgets:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_list_transactions_without_budget(self, client: Firefly) -> None:
        budget = client.budgets.list_transactions_without_budget()
        assert_matches_type(TransactionArray, budget, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_list_transactions_without_budget_with_all_params(self, client: Firefly) -> None:
        budget = client.budgets.list_transactions_without_budget(
            end=parse_date("2026-04-30"),
            limit=10,
            page=1,
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_list_transactions_without_budget(self, client: Firefly) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_list_transactions_without_budget(self, client: Firefly) -> None:
...
class TestAsyncBudgets:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_transactions_without_budget(self, async_client: AsyncFirefly) -> None:
        budget = await async_client.budgets.list_transactions_without_budget()
        assert_matches_type(TransactionArray, budget, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_transactions_without_budget_with_all_params(self, async_client: AsyncFirefly) -> None:
        budget = await async_client.budgets.list_transactions_without_budget(
            end=parse_date("2026-04-30"),
            limit=10,
            page=1,
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_list_transactions_without_budget(self, async_client: AsyncFirefly) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_list_transactions_without_budget(self, async_client: AsyncFirefly) -> None:
