...
from ...types.chart import category_retrieve_overview_params
from ..._base_client import make_request_options
from ...types.chart.category_retrieve_overview_response import CategoryRetrieveOverviewResponse
...
class CategoryResource(SyncAPIResource):
    ...
    ) -> CategoryRetrieveOverviewResponse:
        """
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    category_retrieve_overview_params.CategoryRetrieveOverviewParams,
                ),
            ),
            cast_to=CategoryRetrieveOverviewResponse,
        )
