...
__all__ = ["TransferListWithoutTagParams"]


class TransferListWithoutTagParams(TypedDict, total=False):
    ...
    If you include ID's of asset accounts or liabilities, only transfers from those
