...
class TestCategory:
    ...
    def test_method_retrieve_overview(self, client: Firefly) -> None:
        category = client.chart.category.retrieve_overview(
            end=parse_date("2019-12-27"),
            start=parse_date("2019-12-27"),
        )
        assert_matches_type(CategoryRetrieveOverviewResponse, category, path=["response"])
    ...
    def test_raw_response_retrieve_overview(self, client: Firefly) -> None:
        response = client.chart.category.with_raw_response.retrieve_overview(
            end=parse_date("2019-12-27"),
            start=parse_date("2019-12-27"),
        )
    ...
    def test_streaming_response_retrieve_overview(self, client: Firefly) -> None:
        with client.chart.category.with_streaming_response.retrieve_overview(
            end=parse_date("2019-12-27"),
            start=parse_date("2019-12-27"),
        ) as response:
...
class TestAsyncCategory:
    ...
    async def test_method_retrieve_overview(self, async_client: AsyncFirefly) -> None:
        category = await async_client.chart.category.retrieve_overview(
            end=parse_date("2019-12-27"),
            start=parse_date("2019-12-27"),
        )
        assert_matches_type(CategoryRetrieveOverviewResponse, category, path=["response"])
    ...
    async def test_raw_response_retrieve_overview(self, async_client: AsyncFirefly) -> None:
        response = await async_client.chart.category.with_raw_response.retrieve_overview(
            end=parse_date("2019-12-27"),
            start=parse_date("2019-12-27"),
        )
    ...
    async def test_streaming_response_retrieve_overview(self, async_client: AsyncFirefly) -> None:
        async with async_client.chart.category.with_streaming_response.retrieve_overview(
            end=parse_date("2019-12-27"),
            start=parse_date("2019-12-27"),
        ) as response:
            assert not response.is_closed
